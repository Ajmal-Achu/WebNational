...
                The 2nd National Conference on Intelligent Cyber Physical Systems
                (NCICPS'25) is a premier gathering of researchers, practitioners,
                and innovators in the field of cyber-physical systems and their
                intelligent applications.
              </p>
              <p className="text-gray-300">
                Join us in shaping the future of intelligent systems and their impact
...
                  <p className="text-gray-300">
                    Details about paper presentation will be shown here.
                    You can add more information like submission guidelines,
                    important dates, etc.
                  </p>
                </div>
              )}
...
                  style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'contain', transition: 'opacity 1000ms duration-1000', borderRadius: '0.5rem', opacity: currentImage === index ? 1 : 0 }}
